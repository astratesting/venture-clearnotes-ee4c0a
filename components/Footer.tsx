  ...
  return (
    <footer className="bg-sand-100 border-t border-sand-200">
      <div className="px-6 max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-6 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-sand-600 mb-6 max-w-xs">
                AI-powered meeting summaries built for project managers. Save 2-3 hours weekly and never lose track of deliverables.
              </p>
            ...
            {Object.entries(footerLinks).map(([category, links]) => (
              <div key={category}>
                <h4 className="font-semibold text-sand-900 mb-4">{category}</h4>
        ...
        {/* Bottom bar */}
        <div className="py-6 border-t border-sand-200 flex flex-col md:flex-row items-center justify-between gap-4">
